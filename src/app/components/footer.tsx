...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#191919] text-slate-400 py-8 h-80">
      <div className="container mx-16 mt-6 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
      ...
      <div className='mt-10 flex justify-evenly text-white'><a href='#' className=''>About Us</a>
      <a href='#' className=''>Contact</a>
      <a href='#' className=''>Terms and Conditions</a></div>
